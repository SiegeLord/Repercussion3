...
slhack::actions! {
	Action
	{
		...
		MoveRight = [Some(controls::Input::Keyboard(KeyCode::Right)), Some(controls::Input::JoystickPosAxis(JoystickStick::LeftThumb, 0))],
		MoveUp = [Some(controls::Input::Keyboard(KeyCode::Up)), Some(controls::Input::JoystickNegAxis(JoystickStick::LeftThumb, 1))],
		MoveDown = [Some(controls::Input::Keyboard(KeyCode::Down)), Some(controls::Input::JoystickPosAxis(JoystickStick::LeftThumb, 1))],
		...
		DrillLeft = [Some(controls::Input::Keyboard(KeyCode::A)), Some(controls::Input::JoystickNegAxis(JoystickStick::RightThumb, 0))],
