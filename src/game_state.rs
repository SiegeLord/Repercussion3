...
slhack::actions! {
	Action
	{
		...
		MoveUp = [Some(controls::Input::Keyboard(KeyCode::Up)), Some(controls::Input::JoystickPosAxis(JoystickStick::LeftThumb, 1))],
		MoveDown = [Some(controls::Input::Keyboard(KeyCode::Down)), Some(controls::Input::JoystickNegAxis(JoystickStick::LeftThumb, 1))],
